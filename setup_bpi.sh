...
EndSection
Section "InputClass"
Identifier "Waveshare Touchscreen Calibration"
MatchProduct "WaveShare WaveShare"
Driver "libinput"
Option "CalibrationMatrix" "0 -1 1 1 0 0"
EndSection
EOF
...
cat << EOF > "$TOUCH_RULES"
SUBSYSTEM=="input", ATTRS{name}=="WaveShare WaveShare", ENV{LIBINPUT_CALIBRATION_MATRIX}="0 -1 1 1 0 0"
EOF
...
xinput set-prop 'WaveShare WaveShare' 'libinput Calibration Matrix' 0 -1 1 1 0 0
break
fi
sleep 1
done
